...
function render(error, us, countyData, districtData, sepsis, flu, productTypes, impactAreas, technologyLevels, countries, acceleratorList, productList) {
    ...
    renderGalleryFilters(impactAreas, productTypes, technologyLevels, countries);
    ...
    makeGallery(productList);
}

function renderGalleryFilters(impactAreas, productTypes, techLevels, countries) {
...
function makeGallery(data) {
    ...
    data.forEach(function(d) {
        ...
        output = output +
            "<div class='col-xs-12 col-sm-4 col-md-3 col-lg-3 col-xl-3 productbox " + classProductType + " " + classCountry
